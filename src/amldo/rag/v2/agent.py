"""
RAG v2 - Agente Google ADK com contexto hierárquico.

Agente avançado que usa consultar_base_rag v2 para responder perguntas com
contexto estruturado hierarquicamente (Lei → Título → Capítulo → Artigo).
"""
